...
-module(cowmachine_controller_service_available_false_test).
...
% Run test module
% $ rebar3 eunit -v -m cowmachine_controller_service_available_false_test
...
cowmachine_start_test() ->
	...
	?assertMatch(
		{ok, {{"HTTP/1.1",500,"Internal Server Error"}, _Headers, ""}},
