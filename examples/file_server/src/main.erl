...
ProtocolOpts = fun() ->
	Dispatch = fun() -> 
		...
		RoutePath1 = fun()->
			...
			MIME_TypesModule = cow_mimetypes,
			MIME_TypesModuleFunction = all,
			MIME_Types = {mimetypes, MIME_TypesModule, MIME_TypesModuleFunction},
			Extra = [MIME_Types,
				{dir_handler, directory_h}
			],
			InitialState = {priv_dir, App, PrivPath, Extra}, 
